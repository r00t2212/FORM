...
const COOLDOWN = {
  abs_core: [
    ...
    { name:'Supine Twist', desc:'Lying on back, draw one knee across your body and look the other way. Switch sides halfway.', duration:50 },
  ...
  chest: [
    { name:'Doorframe Chest Stretch', desc:'Press one forearm against a wall at 90°, rotate body away gently. Switch sides halfway.', duration:50 },
    { name:'Thread the Needle', desc:'On all fours, slide one arm under your body until your shoulder touches the mat. Switch sides halfway.', duration:50 },
    { name:'Cross-Body Shoulder Stretch', desc:'Pull one arm across your chest with the opposite hand. Feel the rear delt release. Switch sides halfway.', duration:50 },
  ...
  back: [
    ...
    { name:'Lat Stretch', desc:'Grab a doorframe at shoulder height, shift your hips away until you feel the lat stretch. Switch sides halfway.', duration:50 },
    ...
    { name:'Neck Side Stretch', desc:'Tilt one ear to your shoulder, apply gentle hand pressure. Breathe slowly. Switch sides halfway.', duration:45 },
    { name:'Supine Twist', desc:'Lying on back, draw one knee across your body and look the other way. Switch sides halfway.', duration:50 },
  ...
  arms: [
    { name:'Overhead Tricep Stretch', desc:'Arm overhead, elbow bent, gently pull the elbow back with your other hand. Switch sides halfway.', duration:45 },
    { name:'Cross-Body Bicep Stretch', desc:'Arm extended across chest at shoulder height, palm up. Apply gentle pressure. Switch sides halfway.', duration:45 },
    { name:'Wrist Flexor Stretch', desc:'Arm extended, palm up, pull fingers back gently with the other hand. Switch sides halfway.', duration:40 },
    ...
    { name:'Doorframe Bicep Stretch', desc:'Grip a doorframe at hip height with a supinated grip, rotate body away gently. Switch sides halfway.', duration:45 },
    { name:'Extended Wrist Stretch', desc:'Extend one arm, gently pull all fingers back then push them down. Switch hands halfway.', duration:40 },
  ],
  legs: [
    ...
    { name:'Standing Quad Stretch', desc:'Stand on one leg, pull the other foot toward your glute, knee pointing straight down. Switch sides halfway.', duration:50 },
    ...
    { name:'Standing Calf Stretch', desc:'Step one foot back, press the heel down and lean into a wall. Full gastrocnemius stretch. Switch sides halfway.', duration:50 },
  ...
  full_body: [
    ...
    { name:'Supine Twist', desc:'Lying on back, draw one knee across your body and look the other way. Switch sides halfway.', duration:50 },
    { name:'Figure-4 Glute Stretch', desc:'Lying on back, cross ankle over knee and pull gently toward you. Switch sides halfway.', duration:55 },
    ...
    { name:'Childs Pose with Side Reach', desc:'From child\'s pose, walk hands to one side to stretch the lat. Switch sides halfway.', duration:50 },
